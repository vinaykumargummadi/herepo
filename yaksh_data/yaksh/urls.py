...
urlpatterns = [
    ...
    url(r'^quizzes/view_category/(?P<module_id>\d+)/(?P<course_id>\d+)/$',
    ...
    url(r'^next_unit/(?P<course_id>\d+)/(?P<module_id>\d+)/'
        ...
        views.get_next_unit, name='next_unit'),
    url(r'^contest_categories/(?P<course_id>\d+)/$',
        views.course_modules, name='course_modules'),
    url(r'^forum/contest_forum/(?P<course_id>\d+)/$',
        views.course_forum,
        name='course_forum'),
    ...
    url(r'^manage/duplicate_contest/(?P<course_id>\d+)/$',
        views.duplicate_course, name='duplicate_course'),
    url(r'manage/contests/$', views.courses, name='courses'),
    url(r'manage/add_contest/$', views.add_course, name='add_course'),
    url(r'manage/edit_contest/(?P<course_id>\d+)$', views.add_course,
        name='edit_course'),
    url(r'manage/contest_detail/(?P<course_id>\d+)/$', views.course_detail,
        name='course_detail'),
    ...
    url(r'^manage/create_demo_contest/$', views.create_demo_course,
        name="create_demo_course"),
    url(r'^manage/contests/download_contests_csv/(?P<course_id>\d+)/$',
    ...
    url(r'^manage/contests/download_yaml_template/',
    ...
    url(r'^manage/contests/designcategory/(?P<module_id>\d+)/$',
        views.design_module, name="design_module"),
    url(r'^manage/contests/designcategory/(?P<module_id>\d+)/'
        '(?P<course_id>\d+)/$', views.design_module, name="design_module"),
    url(r'^manage/contests/add_category/(?P<course_id>\d+)/$',
        views.add_module, name="add_module"),
    url(r'^manage/contests/add_cateogory/(?P<course_id>\d+)/(?P<module_id>\d+)/$',
        views.add_module, name="edit_module"),
    url(r'^manage/contests/designcontest/(?P<course_id>\d+)/$',
        views.design_course, name="design_course"),
    url(r'^manage/contest_status/(?P<course_id>\d+)/$',
    ...
    url(r'^manage/contests/download_contest/(?P<course_id>\d+)/$',
        views.download_course, name="download_course"),
    url(r'^download_contest/(?P<course_id>\d+)/$',
        views.download_course, name="download_course"),
    url(r'^manage/contest/enrollments/(?P<course_id>\d+)',
        views.course_students, name="course_students"),
    url(r'^manage/contest/all/categories/(?P<course_id>\d+)',
        views.get_course_modules, name="get_course_modules"),
    url(r'^manage/contest/teachers/(?P<course_id>\d+)',
        views.course_teachers, name="course_teachers"),
    url(r'^manage/download/contest/progress/(?P<course_id>\d+)',
